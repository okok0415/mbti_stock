...
import Hyundai from "../../component/hyundai.png";
import {CopyToClipboard} from "react-copy-to-clipboard";
import {Link} from "react-router-dom";

class ENTP extends React.Component{
    state = {
        value : 0,
        array : {}
    }
        ...
        return (
            ...
            <div className = "result_explain">
                ...
                <div className = "result_img">
                    <img src = {Hyundai} height = '200' weight = '200'/>
                </div>
            ...
            <CopyToClipboard text = {`https://okok0415.github.io/mbti_stock/result/ENTP`}>
